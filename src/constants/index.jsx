...
export const albums = [
    { title: 'Valentina & Alex', folder: 'valentina-alex', note:"Villa Caletas, Jacó", link: '/album/valentina-alex', photographer: {name: "Tiquicia Shot", instagram: "https://www.instagram.com/tiquicia.shot.photo/"} },
    { title: 'Sam & Adam', folder: 'sam-adam', note:"Arenal Kioro Suits & Spa, Arenal", link: '/album/sam-adam', photographer: {name: "Tiquicia Shot", instagram: "https://www.instagram.com/tiquicia.shot.photo/"} },
    ...
    { title: 'Andrea & Alonso', folder: 'andrea-alonso', note:"La Garita, Alajuela", link: '/album/andrea-alonso', photographer: {name: "", instagram: ""} },
    { title: 'Mereya & Anthony', folder: 'mereya-anthony', note:"Villa Caletas, Jacó", link: '/album/mereya-anthony', photographer: {name: "Rob & Lori", instagram: "https://www.instagram.com/rawshoots/"} },
    { title: 'Jiya & Tony', folder: 'jiya-tony', note:"Playa Esterillos", link: '/album/jiya-tony', photographer: {name: "Chloe Murdoch", instagram: "https://www.instagram.com/chloemurdochphotography/"} },
    { title: 'Lital & Marty', folder: 'lital-marty', note:"Villa Caletas, Jacó", link: '/album/lital-marty', photographer: {name: "Rob & Lori", instagram: "https://www.instagram.com/rawshoots/"} },
